...
\section{Habilidades}
  ...
  \resumeSubHeadingListStart
    \small{
        ...
        \item \textbf{Metodologias:} Ágil, Scrum, OOP
    }
  \resumeSubHeadingListEnd
    ...
    \resumeSubheading
      ...
      {Engenheiro de Software}{Mar 2024 \textbf{--} Dez 2024}
        \resumeItemListStart
            ...
            \resumeItem{Durante o desenvolvimento, foram aplicados conceitos da Engenharia de Software, utilizando metodologia ágil e outros princípios. A aplicação foi desenvolvida com base na Clean Architecture (Arquitetura Limpa) e emprega tecnologias como TypeScript, React, NestJS e Prisma.}
        \resumeItemListEnd
